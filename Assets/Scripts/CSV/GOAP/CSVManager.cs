...
namespace GOAP.PlanningData.CSV
{
    ...
    {
        private static string _reportDirectoryName = "GOAP_CSVReport";
        private static string _reportSeparator = ";";
        private static string _mainReportFileName = "goap_moreApples_mainreport";
        private static string _plansReportFileName = "goap_moreApples_plansreport";
